...
def consultation_detail(appointment_id):
    ...
    try:
        ...
        if appointment["token_status"] in ["completed", "cancelled"]:
            return redirect("/doctor_appointments")
        ...
        if request.method == "GET":
            ...
            if appointment["token_status"] == "waiting":
                ...
                # ----------------------------------------
                # Find previous active consultation
                # ----------------------------------------
                ...
                previous_token = cursor.fetchone()

                # ----------------------------------------
                # Finish previous consultation
                # ----------------------------------------
                ...
                appointment["token_status"] = "in_consultation"
